...
{
  "schema": 1,
  "generated_at": "2026-07-03T19:04:40Z",
  ...
  "profiles": [
    {
      ...
      "auth_status": "ok",
      "fetch_status": "Fresh",
      "fetched_at": "2026-07-03T19:04:20Z",
      "next_refresh_at": "2026-07-03T19:09:20Z",
      "auto_start": true,
      "bell_threshold": 90,
      "fallback": { "position": 1, "threshold": 95.0, "armed": true },
      "windows": [
        { "label": "5h",      "utilization_pct": 42.0, "resets_at": "2026-07-03T23:00:00Z" },
        { "label": "7d",      "utilization_pct": 18.0, "resets_at": "2026-07-08T17:00:00Z" },
        { "label": "7d Opus", "utilization_pct": 30.0, "resets_at": "2026-07-08T17:00:00Z" }
      ],
      "third_party": null
    }
  ]
...
| `generated_at` | Write stamp, ISO-8601 UTC (all timestamps are). Readers derive staleness from it: a stamp much older than `refresh_interval_ms` means the daemon is gone/stuck — show last-known data with a stale cue, never spin. |
...
| `profiles[].fetch_status` | `"Fresh" \| "Cached" \| "Failed" \| "RateLimited"` — the usage fetch's last outcome, so readers can distinguish live bars from last-known. `null` = never fetched. |
...
daemon feed and the CLI snapshot cannot drift.
