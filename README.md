...
Most tools in this space do one half; clauth's angle is both halves in one TUI — switching *and* live usage — connected by the auto-switch chain.
